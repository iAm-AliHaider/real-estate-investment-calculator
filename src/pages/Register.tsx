  ...
  return (
    <Flex minH="100vh" align="center" justify="center" bg="gray.50">
      <Box bg="white" p={8} rounded="lg" shadow="lg" minW="350px">
        <Heading mb={6} size="lg" color="gray.700" textAlign="center">Register</Heading>
        {error && (
        ...
        <VStack spacing={4} as="form" onSubmit={handleSubmit}>
          ...
          <Button colorScheme="blue" size="lg" w="full" type="submit" isLoading={loading}>Register</Button>
        </VStack>
        <Text mt={4} textAlign="center" color="gray.500">
          Already have an account?{' '}
          <ChakraLink as={Link} to="/login" color="blue.500" fontWeight="medium">Login</ChakraLink>
        </Text>
      </Box>
    </Flex>
  );
