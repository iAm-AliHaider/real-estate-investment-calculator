            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-2xl border border-blue-100">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center p-3 bg-white/60 rounded-xl">
                  ...
                  <span className="font-bold text-blue-600 text-lg">{formatCurrency(results.totalRevenue)}</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-white/60 rounded-xl">
                  <span className="text-gray-700 font-medium">Total Costs</span>
                  <span className="font-bold text-gray-800 text-lg">{formatCurrency(results.totalCosts)}</span>
                </div>
                <div className="flex justify-between items-center p-4 bg-white/80 rounded-xl border-2 border-gray-200">
                ...
                <div className="flex justify-between items-center p-3 bg-white/60 rounded-xl">
                  ...
                  <span className={`font-bold text-lg ${
                    results.totalRevenue > 0 && (results.grossProfit / results.totalRevenue) > 0 ? 'text-green-600' : 'text-red-600'
                  }`}>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-green-50 p-6 rounded-2xl border border-emerald-100">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center p-3 bg-white/60 rounded-xl">
                  ...
                  <span className="font-bold text-gray-800 text-lg">{Math.ceil(results.breakEvenUnits)} units</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-white/60 rounded-xl">
                  <span className="text-gray-700 font-medium">Payback Period</span>
                  <span className="font-bold text-gray-800 text-lg">{results.paybackPeriod.toFixed(1)} years</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-white/60 rounded-xl">
                  <span className="text-gray-700 font-medium">Break-even %</span>
                  <span className={`font-bold text-lg ${
                    (results.breakEvenUnits / state.numberOfUnits) < 0.8 ? 'text-green-600' : 'text-orange-600'
                  }`}>
